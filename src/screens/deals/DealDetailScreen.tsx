...
export const DealDetailScreen: React.FC = () => {
  ...
  const handleStart = () => {
    Alert.alert('Werk starten', 'Bevestig dat je begint met het werk.', [
      { text: 'Annuleren', style: 'cancel' },
      { text: 'Starten', onPress: () => start(dealId) },
    ]);
  };
  ...
  const handleConfirm = () => {
    Alert.alert(
      'Werk bevestigen',
      'Bevestig dat het werk naar tevredenheid is afgerond.',
      [
        { text: 'Annuleren', style: 'cancel' },
        { text: 'Bevestigen', onPress: () => confirm(dealId) },
      ],
    );
  };
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Card style={styles.section}>
          <Text style={styles.sectionTitle}>Opdracht</Text>
        ...
        {deal.completionPhotos && deal.completionPhotos.length > 0 && (
          <Card style={styles.section}>
            <Text style={styles.sectionTitle}>Bewijs van voltooiing</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              'Probleem melden',
              'Neem contact op met support@spoedmarktplaats.nl',
            )
          }
        >
